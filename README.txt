...
This file provides information on the set of files provided with Stoltzfus & Norris, 2014.  
...
One of the main results is the weighted ratios (weighted by codon use and amino acid exchangeabilities) of transitions to transversions shown in Table 3.  Executing this command 
...
The remaining results of the paper are analyses of studies of the distribution of fitness effects (DFE) shown in tables 1, 2 and 4.  Executing this command 
